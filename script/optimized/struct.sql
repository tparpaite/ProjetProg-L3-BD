...
CREATE TABLE `athlete` (
       ...
       `code_gender` char(1),
       `NOC` char(3),
       CONSTRAINT `FK_athlete_gender`  FOREIGN KEY (`code_gender`) REFERENCES `gender`(`code`),
...
CREATE TABLE `medallist` (
       ...
       CONSTRAINT `FK_medallist_gender`  FOREIGN KEY (`code_gender`) REFERENCES `gender`(`code`),	
